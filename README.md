...
**Wider**: a functional programming language focuses on functions and immutable data structures.
...
Functions in an FP language are first-class citizens. This means 
...
- Our computers are not Van-Neuman machines anymore. They have    parallel 
